...
class Ventas(models.Model):
    ...
    #             vals_list['name'] = self.env['ir.sequence'].with_context(force_company=vals_list['company_id'])\
    #                                     .next_by_code(self._name, sequence_date=None) or '/'
    #         else:
    #             vals_list['name'] = self.env['ir.sequence'].next_by_code(self._name, sequence_date=None) or '/'
